  ...
  return (
    <div>
        <div className='relative mb-[3rem]'>
            ...
            <span
                className={`${level1} bottom-0 h-[6px] absolute bg-[#e7a8c7]`}
            ></span>
        </div>
        <div className='relative mb-[3rem]'>
            <h1 className='p-5 w-[100%] uppercase bg-gray-800 rounded-sm text-white text-[20px] font-bold'>
            ...
            <span
                className={`${level2} bottom-0 h-[6px] absolute bg-[#e7a8c7]`}
            ></span>
        </div>
        <div className='relative mb-[3rem]'>
            <h1 className='p-5 w-[100%] uppercase bg-gray-800 rounded-sm text-white text-[20px] font-bold'>
            ...
            <span
                className={`${level3} bottom-0 h-[6px] absolute bg-[#e7a8c7]`}
            ></span>
        </div>
    </div>
  )
